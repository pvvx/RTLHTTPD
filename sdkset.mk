...
# -------------------------------------------------------------------
LIBS =
all: LIBS +=_platform_new _wlan _p2p _wps _websocket _sdcard _xmodem m c nosys gcc _mdns
mp: LIBS +=_platform_new _wlan_mp _p2p _wps _websocket _sdcard _xmodem m c nosys gcc _mdns
