...
HTML_PATH ?= html
webpages.espfs: $(HTML_PATH) librtlhttpd/espfs/mkespfsimage/mkespfsimage.exe
...
librtlhttpd/espfs/mkespfsimage/mkespfsimage: librtlhttpd/espfs/mkespfsimage/
	$(MAKE) -C librtlhttpd/espfs/mkespfsimage.exe USE_HEATSHRINK="$(USE_HEATSHRINK)" GZIP_COMPRESSION="$(GZIP_COMPRESSION)"
